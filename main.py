...
def boten(message):
    ...
    M = types.InlineKeyboardButton('المطور', url='https://t.me/cap_a7med9460')
...
def masg(call):
	...
	if call.data =="https://t.me/cap_a7med9460":
...
if __name__ == "__main__":
    bot.remove_webhook()
    bot.set_webhook(url="https://capahmedbot.herokuapp.com/"+str(BOT_TOKEN))
